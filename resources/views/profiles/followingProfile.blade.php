<div class="d-flex align-items-center justify-content-between">
    <div class="d-flex align-items-center gap-3">
        <a href="{{ url("/users/profile/".$following->user->id) }}" class="text-decoration-none">
            @php
                $colors = [
        ...
        <div class="d-flex flex-column">
            <a href="{{ url("/users/profile/".$following->user->id) }}" class="text-decoration-none mb-2">
                <b class="h6 text-muted">{{ $following->user->name }}</b>
            </a>
        </div>
    </div>
